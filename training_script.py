...
def print_environment_diagnostics(
    ...
    print(f"  Features   : [grid_zone, distance_to_basket, closest_defender_dist,")
    print(f"                num_defenders_within_6ft, best_teammate_openness,")
    print(f"                num_open_teammates, shot_clock, is_three_point_zone,")
    print(f"                ball_handler_zone_fg_pct, best_open_teammate_dist_to_basket,")
    print(f"                best_open_teammate_zone_fg_pct]")
    print("Action Space:")
